AGENTS = [
    {
        ...
        "icon": '<i data-lucide="handshake" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "cluster": "Value Capture",
        "cluster_color": "#A100FF",
        "icon": '<i data-lucide="search" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "cluster": "Value Capture",
        "cluster_color": "#A100FF",
        "icon": '<i data-lucide="wallet" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "icon": '<i data-lucide="shield" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "cluster": "Risk & Compliance",
        "cluster_color": "#F76C6C",
        "icon": '<i data-lucide="leaf" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "icon": '<i data-lucide="zap" class="nav-icon"></i>',
    ...
    },
    {
        ...
        "cluster": "Agility & Insight",
        "cluster_color": "#12B3A3",
        "icon": '<i data-lucide="layout-dashboard" class="nav-icon"></i>',
